...
//               builder: (context) => AddOrEditTask(
//                 isNewTask: false,
//                 task: dataProvider.getIncompleteTasks[widget.index],
//               ),
//             ),
//           );
//         },
//         highlightColor: Constants.getPriorityColor(widget.task.priority),
//         child: Padding(
//           padding: const EdgeInsets.symmetric(horizontal: 8.0, vertical: 12.0),
//           child: ListTile(
//             leading: Transform.scale(
//               scale: 1.5,
//               child: Checkbox(
//                 focusColor: Color(Constants.getPriorityColor(widget.task.priority)),
//                 side: BorderSide(
//                   color: DataProvider.of(context)
